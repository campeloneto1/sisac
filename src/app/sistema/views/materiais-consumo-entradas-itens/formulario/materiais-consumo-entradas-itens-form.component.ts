...
@Component({
    selector: "app-materiais-consumo-entradas-itens-form",
    templateUrl: './materiais-consumo-entradas-itens-form.component.html',
    styleUrl: './materiais-consumo-entradas-itens-form.component.css',
    standalone: true,
    imports: [
        CommonModule,
        FormsModule, 
...
export class MateriaisConsumoEntradasItensFormComponent implements OnInit, OnDestroy{
    ...
    @Input() material_consumo_entrada_id!: any;
    ...
    ngOnInit() {
        this.form = this.formBuilder.group({
            ...
            'material_consumo_entrada': [this.material_consumo_entrada_id],
    ...
    cadastrar(){
        if(this.form.value.id){
            this.materiaisConsumoEntradasItensService.update(this.form.value.id, this.form.value).subscribe({
                next: (data:any) => {
            ...
            this.materiaisConsumoEntradasItensService.create(this.form.value).subscribe({
                next: (data:any) => {
