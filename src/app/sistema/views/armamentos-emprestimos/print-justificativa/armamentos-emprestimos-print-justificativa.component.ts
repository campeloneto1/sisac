...
@Component({
    selector: 'app-armamento-emprestimo-print-justificativa',
    templateUrl: './armamentos-emprestimos-print-justificativa.component.html',
    styleUrl: './armamentos-emprestimos-print-justificativa.component.css',
    standalone: true,
    imports: [
        CommonModule,
        NgxMaskDirective, 
...
export class ArmamentosEmprestimosPrintJustificativa implements OnInit, OnDestroy{
